...
class Files {
     ...
     */
    getThumbnail(fileID, options, callback) {
        var params = {
            qs: options,
            json: false,
        };
    ...
    createUploadSession(folderID, size, name, callback) {
        var apiURL = this.client._uploadBaseURL +
            urlPath(BASE_PATH, UPLOAD_SESSION_SUBRESOURCE), params = {
            body: {
                folder_id: folderID,
                file_size: size,
                file_name: name,
    ...
    createNewVersionUploadSession(fileID, size, callback) {
        var apiURL = this.client._uploadBaseURL +
            urlPath(BASE_PATH, fileID, UPLOAD_SESSION_SUBRESOURCE), params = {
            body: {
                file_size: size,
            },
        };
    ...
    commitUploadSession(sessionID, fileHash, options, callback) {
        ...
        var apiURL = this.client._uploadBaseURL +
            urlPath(BASE_PATH, UPLOAD_SESSION_SUBRESOURCE, sessionID, 'commit'), params = {
            headers: {
                Digest: `SHA=${fileHash}`,
            },
            body: {
    ...
    getUploadSessionParts(sessionID, options, callback) {
        var apiURL = this.client._uploadBaseURL +
            urlPath(BASE_PATH, UPLOAD_SESSION_SUBRESOURCE, sessionID, 'parts'), params = {
            qs: options,
        };

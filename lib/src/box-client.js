...
// ------------------------------------------------------------------------------
import CollaborationAllowlist from './managers/collaboration-allowlist.ts';
import Collaborations from './managers/collaborations.ts';
import Collections from './managers/collections.ts';
import Comments from './managers/comments.ts';
import DevicePins from './managers/device-pins.ts';
import Enterprise from './managers/enterprise.ts';
import Events from './managers/events.ts';
import Files from './managers/files.ts';
import Folders from './managers/folders.ts';
import Groups from './managers/groups.ts';
import LegalHoldPolicies from './managers/legal-hold-policies.ts';
import Metadata from './managers/metadata.ts';
import RecentItems from './managers/recent-items.ts';
import RetentionPolicies from './managers/retention-policies.ts';
import Search from './managers/search.ts';
import SharedItems from './managers/shared-items.ts';
import SignRequests from './managers/sign-requests.generated.ts';
import StoragePolicies from './managers/storage-policies.ts';
import Tasks from './managers/tasks.ts';
import TermsOfService from './managers/terms-of-service.ts';
import Trash from './managers/trash.ts';
import Users from './managers/users.ts';
import WebLinks from './managers/web-links.ts';
...
class BoxClient {
    ...
    constructor(apiSession, config /* FIXME */, requestManager) {
        ...
        this.batchExec = util.deprecate(function (callback) {
            ...
            var params = {
                body: {
                    requests: this._batch.map((batchReq /* FIXME */) => formatRequestForBatch(batchReq.params)),
                },
            };
